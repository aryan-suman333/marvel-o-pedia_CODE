          ...
          return <div key={title} className="h-screen">
            ...
            <a href={element.cover_url} className="md:min-w-[382px]" target="_blank" rel="noreferrer">
              ...
              <div className="flex flex-col justify-between p-4 leading-normal">
                ...
                {keyword === "movies"?<p className="mb-3 font-normal text-gray-400"><span className="font-semibold">Box Office Collection: </span>{(parseInt(element.box_office) / 10000000).toFixed(2)} cr$</p>:null}
